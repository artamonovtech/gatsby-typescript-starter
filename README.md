...
1.  **Create a Gatsby site.**
    ...
    ```sh
    gatsby new gatsby-typescript-starter https://github.com/artamonovtech/gatsby-typescript-starter
    ```

2.  **Start developing.**

    Navigate into your new siteвЂ™s directory and start it up.
...
2. This project comes with an out-of-the-box [`tsconfig.json`](./tsconfig.json) config file.
